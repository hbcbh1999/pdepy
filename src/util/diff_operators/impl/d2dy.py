...
class d2dy(diff_op.diff_operator):
    ...
    def getIrregularStencil(self, dy, tau, direction):
        ...
        if direction == diff_op.Direction.POSITIVE:
            return [irregular_stencil_node((0, -1), c1/dy**2), irregular_stencil_node((0, 0), c2/dy**2), irregular_stencil_node((0, tau), c3/dy**2, True)]
        elif direction == diff_op.Direction.NEGATIVE:
            return [irregular_stencil_node((0, -tau), c3/dy**2, True), irregular_stencil_node((0, 0), c2/dy**2), irregular_stencil_node((0, 1), c1/dy**2)]